...
full_background = pygame.image.load('./assets/Background/Untitled.png').convert_alpha()
...
class Obstacle(pygame.sprite.Sprite):
    def __init__(self, foo):
        ...
        self.rect = self.image.get_rect(midbottom=(random.randint(700, 1100), y_pos))
    ...
    if obstacle_list:
        for obstacle_rect in obstacle_list:
            ...
            if obstacle_rect.bottom == 420:
                screen.blit(dog_surf, obstacle_rect)
            else:
                screen.blit(obstacle_rect)
...
pygame.display.set_caption("Corgi Jump")
...
game_name = test_font.render("Corgi Jump", False, (111, 196, 169))
...
async def main(): # this function allows for web interface
    global game_active
    global start_time
    global score
    global scroll
    global dog_frames
    global dog_frame_index
    global dog_surf
    ...
    while True:
        ...
        if game_active:
            for i in range(0, tiles):
                screen.blit(full_background, (i * back_width + scroll, 0))
